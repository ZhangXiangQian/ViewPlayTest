...
public class SlidingPlayView extends LinearLayout {
	...
	private SlidInnerViewPager mViewPager;
	...
	private SlidOnItemClickListener mOnItemClickListener;
	private SlidOnChangeListener mAbChangeListener;
	private SlidOnScrollListener mAbScrolledListener;
	private SlidOnTouchListener mAbOnTouchListener;
	...
	private SlidViewPagerAdapter mAbViewPagerAdapter = null;
	/** 导航的点父View */
	...
	public SlidingPlayView(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public void initView(Context context) {
		...
		mViewPager = new SlidInnerViewPager(context);
		// // 手动创建的ViewPager,如果用fragment必须调用setId()方法设置一个id
		// mViewPager.setId(1985);
		// 导航的点
		mPageLineLayoutParent = new LinearLayout(context);
		// mPageLineLayoutParent.setPadding(left, top, right, bottom);
		...
		// 得到导航点的图片资源文件
		displayImage = getBitmapFormSrc("point_display.png");
		hideImage = getBitmapFormSrc("point_hide.png");

		mListViews = new ArrayList<View>();
		mAbViewPagerAdapter = new SlidViewPagerAdapter(context, mListViews);
	...
	public void setOnItemClickListener(
			SlidOnItemClickListener onItemClickListener) {
	 ...
	 */
	public void setOnPageChangeListener(SlidOnChangeListener abChangeListener) {
	...
	public void setOnPageScrolledListener(
			SlidOnScrollListener abScrolledListener) {
	 ...
	 * @throws
	 */
	public void setOnTouchListener(SlidOnTouchListener abOnTouchListener) {
