...
public class SlidInnerViewPager extends ViewPager{
	...
	public SlidInnerViewPager(Context context) {
		super(context);
	 ...
	 */
	public SlidInnerViewPager(Context context, AttributeSet attrs) {
		super(context, attrs);
		mGestureDetector = new GestureDetector(new YScrollDetector());
		setFadingEdgeLength(0);
	}
